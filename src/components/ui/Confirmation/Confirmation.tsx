    ...
    <ConfirmationContainer>
      <ConfirmationContent>
        ...
        <ConfirmationInfo>
          ...
          <ConfirmationRow><TitleH3>Data:</TitleH3><MinorTextH4> {booking.date?.slice(0, 2)} / {booking.date?.slice(3, 5)}</MinorTextH4></ConfirmationRow>
          <ConfirmationRow><TitleH3>Horário:</TitleH3><MinorTextH4> {booking.time}</MinorTextH4></ConfirmationRow>
